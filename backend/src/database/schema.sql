...
CREATE TABLE IF NOT EXISTS personality_responses (
    id SERIAL PRIMARY KEY,
    user_id INTEGER UNIQUE NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    question1_answer VARCHAR(2),
    question2_answer VARCHAR(2),
    question3_answer VARCHAR(2),
    question4_answer VARCHAR(2),
    question5_answer VARCHAR(2),
    question6_answer VARCHAR(2),
    question7_answer VARCHAR(2),
    question8_answer VARCHAR(2),
    question9_answer VARCHAR(2),
    question10_answer VARCHAR(2),
    question11_answer VARCHAR(2),
    question12_answer VARCHAR(2),
